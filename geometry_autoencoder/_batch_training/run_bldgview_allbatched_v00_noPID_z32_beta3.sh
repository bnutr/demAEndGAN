...
python _main_training.py --train True --seed 1 --cuda True \
    ...
    --beta 3 --viz_on True --viz_name bldgview_top_v00_noPID_z32_beta3 \
...
python _main_training.py --train True --seed 1 --cuda True \
    ...
    --ratio_train 0.8 --ratio_val 0.1 \
    --gather_epoch 1 --display_epoch 10 --save_epoch 50 \
    --beta 3 --viz_on True --viz_name bldgview_nw_v00_noPID_z32_beta3 \
    --is_PID False --KL_loss 120 --image_size 128 ;
...
python _main_training.py --train True --seed 1 --cuda True \
    ...
    --ratio_train 0.8 --ratio_val 0.1 \
    --gather_epoch 1 --display_epoch 10 --save_epoch 50 \
    --beta 3 --viz_on True --viz_name bldgview_se_v00_noPID_z32_beta3 \
    --is_PID False --KL_loss 120 --image_size 128 ;
...
#     --ratio_train 0.8 --ratio_val 0.1 \
#     --gather_epoch 1 --display_epoch 10 --save_epoch 50 \
#     --beta 3 --viz_on True --viz_name bldgview_allparallel_v00_noPID_z32_beta3 \
#     --is_PID False --KL_loss 120 --image_size 128 ;