...
python _main_training.py --train True --seed 1 --cuda True \
    ...
    --beta 1 --viz_on True --viz_name bldgview_top_v13_PID_z32_KL50 \
...
python _main_training.py --train True --seed 1 --cuda True \
    ...
    --ratio_train 0.8 --ratio_val 0.1 \
    --gather_epoch 1 --display_epoch 10 --save_epoch 50 \
    --beta 1 --viz_on True --viz_name bldgview_nw_v13_PID_z32_KL50 \
    --is_PID True --KL_loss 50 --image_size 128 ;
...
python _main_training.py --train True --seed 1 --cuda True \
    ...
    --ratio_train 0.8 --ratio_val 0.1 \
    --gather_epoch 1 --display_epoch 10 --save_epoch 50 \
    --beta 1 --viz_on True --viz_name bldgview_se_v13_PID_z32_KL50 \
    --is_PID True --KL_loss 50 --image_size 128 ;
...
#     --ratio_train 0.8 --ratio_val 0.1 \
#     --gather_epoch 1 --display_epoch 10 --save_epoch 50 \
#     --beta 1 --viz_on True --viz_name bldgview_allparallel_v13_PID_z32_KL50 \
#     --is_PID True --KL_loss 50 --image_size 128 ;