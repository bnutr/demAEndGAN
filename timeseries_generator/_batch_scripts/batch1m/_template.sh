...
python gan/main.py --train_mode True \
    --data_folder d_small_XXX_nooutlier_auxl_1m_YY --run_folder_name run_d_small_XXX_nooutlier_auxl_1m_YY \
...
python gan/main.py --train_mode True \
    --data_folder d_small_XXX_nooutlier_auxl_1m_ZZ --run_folder_name run_d_small_XXX_nooutlier_auxl_1m_ZZ \
    --dataset_name train --model_name model \
    --epoch 400 --batch_size 100 --sample_len 24 \
    --d_rounds 1 --g_rounds 1 \
    --g_feature_feedback False --g_feature_noise True \
...
python gan/main.py --train_mode True \
    --data_folder d_small_XXX_nooutlier_auxl_1m_AA --run_folder_name run_d_small_XXX_nooutlier_auxl_1m_AA \
    --dataset_name train --model_name model \
    --epoch 400 --batch_size 100 --sample_len 24 \
    --d_rounds 1 --g_rounds 1 \
    --g_feature_feedback False --g_feature_noise True \
