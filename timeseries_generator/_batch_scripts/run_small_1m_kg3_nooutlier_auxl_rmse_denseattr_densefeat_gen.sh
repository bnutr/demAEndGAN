...
python gan/main.py --train_mode False \
    --data_folder d_small_kg3_nooutlier_auxl_1m --run_folder_name run_d_small_kg3_nooutlier_auxl_1m_rmse_denseattr_densefeat \
    ...
    --g_attribute_latent_dim 5 --g_attribute_num_layers 6 --g_attribute_num_units 200 \
