...
python gan/main.py --train_mode True \
    --data_folder d_small_kg1_nooutlier_auxl_1m_nd_01 --run_folder_name run_d_small_kg1_nooutlier_auxl_1m_nd_01 \
    ...
    --epoch_checkpoint_freq 1 --vis_freq 150 --vis_num_sample 2 ;
...
python gan/main.py --train_mode True \
    --data_folder d_small_kg1_nooutlier_auxl_1m_nd_02 --run_folder_name run_d_small_kg1_nooutlier_auxl_1m_nd_02 \
    --dataset_name train --model_name model \
    --epoch 400 --batch_size 100 --sample_len 24 \
...
python gan/main.py --train_mode True \
    --data_folder d_small_kg1_nooutlier_auxl_1m_nd_03 --run_folder_name run_d_small_kg1_nooutlier_auxl_1m_nd_03 \
    --dataset_name train --model_name model \
    --epoch 400 --batch_size 100 --sample_len 24 \
    --d_rounds 1 --g_rounds 1 \
    --g_feature_feedback False --g_feature_noise True \
