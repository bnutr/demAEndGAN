...
python gan/main.py --train_mode True \
    --data_folder d_small_kg3_nooutlier_auxl_1m_nd_07 --run_folder_name run_d_small_kg3_nooutlier_auxl_1m_nd_07 \
...
python gan/main.py --train_mode True \
    --data_folder d_small_kg3_nooutlier_auxl_1m_nd_08 --run_folder_name run_d_small_kg3_nooutlier_auxl_1m_nd_08 \
    --dataset_name train --model_name model \
    --epoch 400 --batch_size 100 --sample_len 24 \
    --d_rounds 1 --g_rounds 1 \
    --g_feature_feedback False --g_feature_noise True \
...
python gan/main.py --train_mode True \
    --data_folder d_small_kg3_nooutlier_auxl_1m_nd_09 --run_folder_name run_d_small_kg3_nooutlier_auxl_1m_nd_09 \
    --dataset_name train --model_name model \
    --epoch 400 --batch_size 100 --sample_len 24 \
    --d_rounds 1 --g_rounds 1 \
    --g_feature_feedback False --g_feature_noise True \
